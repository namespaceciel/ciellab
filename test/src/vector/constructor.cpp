...
template<class C>
void test_default_constructor_with_allocator_impl(::testing::Test*) {
    using Alloc = typename C::allocator_type;
...
template<class C>
void test_copy_constructor_with_allocator_impl(::testing::Test*) {
    using T     = typename C::value_type;
    using Alloc = typename C::allocator_type;
...
template<class C>
void test_move_constructor_with_allocator_impl(::testing::Test*) {
    using T     = typename C::value_type;
    using Alloc = typename C::allocator_type;
