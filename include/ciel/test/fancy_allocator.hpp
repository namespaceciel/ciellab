#ifndef CIELLAB_INCLUDE_CIEL_TEST_FANCY_ALLOCATOR_HPP_
...
public:
    ...
    CIEL_NODISCARD friend bool operator==(min_pointer x, min_pointer y) noexcept {
...
public:
    ...
    min_pointer& operator++() noexcept {
        ++ptr_;
        return *this;
    }

    CIEL_NODISCARD min_pointer operator++(int) noexcept {
    ...
    min_pointer& operator+=(difference_type n) noexcept {
        ptr_ += n;
        return *this;
    }
    ...
    CIEL_NODISCARD min_pointer operator+(difference_type n) const noexcept {
        min_pointer tmp(*this);
        tmp += n;
        return tmp;
    }

    CIEL_NODISCARD friend min_pointer operator+(difference_type n, min_pointer x) noexcept {
        return x + n;
    }
    ...
    CIEL_NODISCARD friend difference_type operator-(min_pointer x, min_pointer y) noexcept {
        return x.ptr_ - y.ptr_;
    }
    ...
    CIEL_NODISCARD static min_pointer pointer_to(T& t) noexcept {
...
public:
    ...
    CIEL_NODISCARD static min_pointer pointer_to(const T& t) noexcept {
        return min_pointer(std::addressof(t));
    }
    ...
    CIEL_NODISCARD friend bool operator==(min_pointer x, nullptr_t) noexcept {
        return x.ptr_ == nullptr;
    }

    CIEL_NODISCARD friend bool operator==(nullptr_t, min_pointer x) noexcept {
        return x.ptr_ == nullptr;
    }
...
public:
    ...
    CIEL_NODISCARD pointer allocate(ptrdiff_t n) {
    ...
    void deallocate(pointer p, ptrdiff_t n) noexcept {
...
#endif // CIELLAB_INCLUDE_CIEL_TEST_FANCY_ALLOCATOR_HPP_
